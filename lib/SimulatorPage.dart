...
class _SimulatorPage extends State<SimulatorPage> {
  ...
  bool isBeforeOverTimeError = false;
                          ...
                          child:
                            ...
                            onPressed: () {
                              ...
                              setState(() {
                                ...
                                isAddTime2 = false;
                                isAddTime3 = false;
                                isBeforeOverTime = false;
                                is15MinOverTime = false;
                                is30MinOverTime = false;
                                is45MinOverTime = false;
                                is1HourOverTime = false;
                                isBeforeOverTimeError = false;
                              });
                            },
                          ),
                        ),
                        ...
                        Expanded(
                          child:
                            ...
                            onPressed: () {
                              ...
                              // 後残業代を求める計算式
                              int after_over_time =
                                  int.parse(_after_over_time.text);
                              ...
                              // 有給代を求める計算式
                              int paid_holiday_fee = (fix *
                                      double.parse(work_time) *
                                      paid_holiday_count)
                                  .ceil();
